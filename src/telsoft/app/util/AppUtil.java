...
public class AppUtil {
  ...
  ////////////////////////////////////////////////////////
  public static String nvlEx(Object objInput,
                             String strNullValue) {
  ...
  // Out: String[]
  ////////////////////////////////////////////////////////////////////////////
  public static String[] splitByWidth(String strContent,
      ...
      if (width == 0) {
        ...
        if (strContent.equalsIgnoreCase("")) {
          ...
          if (strContent.length() <= width) {
            ...
            strResult[NumSeg -
                1] = strContent.substring(startPos, strContent.length());
            return strResult;
          }
        }
      }
  ...
  /////////////////////////////////////////////////////////////////////////
  public static String[] splitString(String pstrString,
                                     String pWilcard) {
  ...
  ////////////////////////////////////////////////////////
  public static String getInfo(String strInfo,
                               String strParam,
                               String strSplit) {
    String strReturn = "";
  ...
  ////////////////////////////////////////////////////////
  public static void SendSMS(Connection cn,
                             String strSystem,
                             String strISDNList,
                             String strContent,
                             String strServiceCode) throws Exception {
    if (strISDNList != null) {
      ...
      try {
        if ( (isize > 0) && (!arrISDNList[0].equals(""))) {
          String strSQL = "INSERT INTO RESPOND_LOG (SEQUENCE_ID, RECORD_DATETIME, SYSTEM_CODE, ISDN, SERVICE_CODE, CONTENT, SMS_TYPE, SMSC_ID, STATUS) " +
  ...
  public static void SendSMS(Connection cn,
                             ...
                             String strProcessID) throws Exception {
    if (strISDNList != null) {
      String[] arrISDNList = StringUtil.toStringArray(strISDNList, ";");
      int isize = arrISDNList.length;
      PreparedStatement pstmt = null;
  ...
  ////////////////////////////////////////////////////////
  public static int getNumber(String strArray,
                              String strSplit) throws Exception {
    String[] strInfoArray = StringUtil.toStringArray(strArray, strSplit);
    return strInfoArray.length;
  }

  ////////////////////////////////////////////////////////
  public static int getStringPos(String strInfo,
                                 String strArray,
                                 String strSplit) throws Exception {
    String[] strInfoArray = StringUtil.toStringArray(strArray, strSplit);
    for (int i = 0; i < strInfoArray.length; i++) {
  ...
  ////////////////////////////////////////////////////////
  public static String getStringPos(int iPos,
                                    String strArray,
                                    String strSplit) throws Exception {
    String[] strInfoArray = StringUtil.toStringArray(strArray, strSplit);
  ...
  ////////////////////////////////////////////////////////
  public static String getStringFirst(String strArray,
                                      String strSplit) throws Exception {
    String[] strInfoArray = StringUtil.toStringArray(strArray, strSplit);
  ...
  ////////////////////////////////////////////////////////
  public static int getStringFirstPos(String strArray,
                                      String strSplit) throws Exception {
    String[] strInfoArray = StringUtil.toStringArray(strArray, strSplit);
  ...
  ////////////////////////////////////////////////////////
  public static String setStringPos(int iPos,
                                    String strArray,
                                    String strReplace,
                                    String strSplit) throws Exception {
    String strReturn = "";
  ...
  ////////////////////////////////////////////////////////
  public static String buildCallBarringCMD(Connection cn,
                                           String strISDN,
                                           String strCB_BL_Action,
                                           String strCB_WL_Action,
                                           String strCB_Other_Action,
                                           String strCB_Other_Cli_Status,
                                           String strCB_Other_Act_Type,
                                           String strInCBAction,
                                           String strInCBCli00,
                                           String strInCBTreef,
                                           String strInCBOtherCli,
                                           String strInCBActionType) throws
      Exception {
    String strCB_Command = "";
    PreparedStatement stmt = null;
    ResultSet rs = null;
    String strSQL = " Select phone, type, bare_phone, tree_ref " +
        " From callbarring_info " +
        " where Isdn = ?" +
        " and status = '1'";
    ...
    try {
      ...
      if (!strCB_Other_Action.equals("")) {
        ...
        strInCBAction = setStringPos(iTotal - 1, strInCBAction,
                                     strCB_Other_Action, "&");
      }

      if (!strCB_Other_Act_Type.equals("")) {
        int iTotal = getNumber(strInCBActionType, "&");
        strInCBActionType = setStringPos(iTotal - 1, strInCBActionType,
                                         strCB_Other_Act_Type, "&");
      }
  ...
  ////////////////////////////////////////////////////////
  public static boolean indexOf(String strOrg,
                                String strDes,
                                String strSplit) {
  ...
  ////////////////////////////////////////////////////////
  public static Map processModule(Map mData,
                                  Vector vtData,
                                  Map mProcessResult,
    ...
    try {
      Class[] paramType = {
          Map.class, Vector.class, Map.class, Connection.class};
      Object[] objList = {
          mData, vtData, mProcessResult, cConnection};
  ...
  public static boolean compareDate(String strOperator, java.util.Date dtValue,
                                    java.util.Date dtCompare) {
    ...
    else if (strOperator.equals("3") &&
             (dtValue.after(dtCompare) || dtValue.equals(dtCompare))) { //">="
      return true;
    }
    else if (strOperator.equals("4") &&
             (dtValue.before(dtCompare) || dtValue.equals(dtCompare))) { //"<="
      return true;
    }
  ...
  public static boolean compareString(String strOperator, String strValue,
                                      String strCompare) {
    if (strOperator.equalsIgnoreCase("7") &&
        strValue.equalsIgnoreCase(strCompare)) { //"EQUALS"
      return true;
    }
    else if (strOperator.equals("8") && strValue.contains(strCompare)) { //"IN"
      return true;
    }
    else if (strOperator.equals("9") && !strValue.contains(strCompare)) { //"NOT IN"
      return true;
    }
    return false;
  }

  public static boolean compareInteger(String strOperator, int iValue,
                                       int iCompare) {
  ...
  public static boolean compareLong(String strOperator, long lValue,
                                    long lCompare) {
