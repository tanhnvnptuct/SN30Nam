...
//	protected ShortMessage shortMessage = new ShortMessage(Data.SM_MSG_LEN);
       	protected ShortMessage shortMessage = new ShortMessage(500);
	...
	private TLVOctets callbackNumAtag = new TLVOctets(Data.OPT_PAR_CALLBACK_NUM_ATAG, Data.OPT_PAR_CALLBACK_NUM_ATAG_MIN,
	...
	public void setShortMessage(String value, String encoding) throws WrongLengthOfStringException,
